...
export const dailySessions: DailySession[] = [
  ...
  // ───── Сессия 5: Предсонная мягкая (21:30) ─────
  // Тепло → Упр.1 мягко → Упр.2 гравитация → Расслабление → Сон до 23:00!
  {
    id: 5,
    time: '21:30',
    type: 'light',
    name: 'Предсонная мягкая',
    durationMin: 25,
    steps: [
      {
        label: 'Тёплый компресс',
      ...
      },
      {
        ...
        reps: 8,
        durationMin: 6,
        note: 'Мягко, без агрессии. Подготовка ко сну.',
      },
      {
        exerciseId: 'ex_gravity_flexion',
        label: 'Упр.2 — Гравитационное сгибание (расслабленно)',
        durationMin: 5,
        note: 'Расслабленно, 5 минут. Не напрягать руку.',
      },
      {
        label: 'Расслабление',
        durationMin: 3,
        note: 'Расслабление, подготовка ко сну. Сон до 23:00!',
      },
    ],
  },
]
